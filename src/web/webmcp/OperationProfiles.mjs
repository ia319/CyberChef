...
import {BOUNDED_NUMERIC_DECODE_OPERATION_PROFILE_CONFIGS} from
    "./BoundedNumericDecodeOperationProfiles.mjs";
import {BOUNDED_TEXT_CONVERSION_OPERATION_PROFILE_CONFIGS} from
    "./BoundedTextConversionOperationProfiles.mjs";
import {BRAILLE_OPERATION_PROFILE_CONFIGS} from "./BrailleOperationProfiles.mjs";
import {BYTE_TEXT_ENCODING_OPERATION_PROFILE_CONFIGS} from
    "./ByteTextEncodingOperationProfiles.mjs";
import {CHARACTER_ENCODING_OPERATION_PROFILE_CONFIGS} from
    "./CharacterEncodingOperationProfiles.mjs";
import { DATA_FORMAT_OPERATION_PROFILE_CONFIGS } from "./DataFormatOperationProfiles.mjs";
import {ENDIANNESS_OPERATION_PROFILE_CONFIGS} from "./EndiannessOperationProfiles.mjs";
import {FLOAT_DATA_FORMAT_OPERATION_PROFILE_CONFIGS} from
    "./FloatDataFormatOperationProfiles.mjs";
import {HEXDUMP_OPERATION_PROFILE_CONFIGS} from "./HexdumpOperationProfiles.mjs";
import {HEX_TO_PEM_OPERATION_PROFILE_CONFIGS} from "./HexToPemOperationProfiles.mjs";
import {IP_FORMAT_OPERATION_PROFILE_CONFIGS} from "./IpFormatOperationProfiles.mjs";
import {LINEAR_DATA_FORMAT_OPERATION_PROFILE_CONFIGS} from
    "./LinearDataFormatOperationProfiles.mjs";
import {MIME_DECODING_OPERATION_PROFILE_CONFIGS} from
    "./MimeDecodingOperationProfiles.mjs";
import {NUMERIC_DATA_FORMAT_OPERATION_PROFILE_CONFIGS} from
    "./NumericDataFormatOperationProfiles.mjs";
import {OTP_OPERATION_PROFILE_CONFIGS} from "./OtpOperationProfiles.mjs";
import {PEM_OPERATION_PROFILE_CONFIGS} from "./PemOperationProfiles.mjs";
import {QUOTED_PRINTABLE_OPERATION_PROFILE_CONFIGS} from
    "./QuotedPrintableOperationProfiles.mjs";
...
const ENDIANNESS_OPERATION_PROFILES = Object.freeze(
    ENDIANNESS_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const FLOAT_DATA_FORMAT_OPERATION_PROFILES = Object.freeze(
    FLOAT_DATA_FORMAT_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const HEXDUMP_OPERATION_PROFILES = Object.freeze(
    HEXDUMP_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const HEX_TO_PEM_OPERATION_PROFILES = Object.freeze(
    HEX_TO_PEM_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const IP_FORMAT_OPERATION_PROFILES = Object.freeze(
    IP_FORMAT_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
...
const MIME_DECODING_OPERATION_PROFILES = Object.freeze(
    MIME_DECODING_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
...
const BOUNDED_NUMERIC_DECODE_OPERATION_PROFILES = Object.freeze(
    BOUNDED_NUMERIC_DECODE_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const BOUNDED_TEXT_CONVERSION_OPERATION_PROFILES = Object.freeze(
    BOUNDED_TEXT_CONVERSION_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const BRAILLE_OPERATION_PROFILES = Object.freeze(
    BRAILLE_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const BYTE_TEXT_ENCODING_OPERATION_PROFILES = Object.freeze(
    BYTE_TEXT_ENCODING_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const CHARACTER_ENCODING_OPERATION_PROFILES = Object.freeze(
    CHARACTER_ENCODING_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const NUMERIC_DATA_FORMAT_OPERATION_PROFILES = Object.freeze(
    NUMERIC_DATA_FORMAT_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
const PEM_OPERATION_PROFILES = Object.freeze(
    PEM_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
...
const PUNYCODE_OPERATION_PROFILES = Object.freeze(
    PUNYCODE_OPERATION_PROFILE_CONFIGS.map(defineOperationProfile)
);
